...
public:
	...
	static void SplitCharAttributes(const FCharAttributes& InAttributes, FText& OutName, float& OutSpeed, float& OutMass, float& OutJumpVelocity, float& OutAirControl, float& OutDefense)
	{
	...
	UFUNCTION(BlueprintPure, Category = "Character Attributes")
	static void SplitCharData(const FCharacters& InCharacterData, FName& OutCharID, FText& OutCharacterName, FText& OutName, float& OutSpeed, float& OutMass, float& OutJumpVelocity, float& OutAirControl, float& OutDefense, TSubclassOf<AWeapon>& OutMainWeapon)
	{
		OutCharID = InCharacterData.CharID;

		SplitCharAttributes(InCharacterData.Attributes, OutName, OutSpeed, OutMass, OutJumpVelocity, OutAirControl, OutDefense);
